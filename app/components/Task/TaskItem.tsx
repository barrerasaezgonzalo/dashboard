  ...
  return (
    ...
    >
      <div className="flex min-w-0 items-center gap-2 p-4">
        ...
        >
          <div
            className={`flex h-6 w-6 items-center justify-center rounded-full border ${currentStatus.bg} ${currentStatus.border} `}
          >
            <StatusIcon size={12} strokeWidth={3} className="text-white/80" />
          </div>
        </button>
