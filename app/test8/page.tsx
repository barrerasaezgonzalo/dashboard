...
import { ArrowLeft, Ban, Check, History, LogIn, Sparkles } from "lucide-react";
      ...
      <div className="relative flex max-h-[92vh] w-full max-w-lg flex-col border border-white/50 bg-white/95 shadow-2xl backdrop-blur-md">
        ...
        <div className="custom-scroll overflow-y-auto px-5 pb-6 pt-2">
          ...
          <section className="mt-5">
            <div className="mb-3">
              <h2 className="mt-1 text-lg font-semibold text-neutral-700 text-center">
                Revisa cómo fue este ciclo y qué actividades resultaron más
                fáciles o difíciles para ti.
              </h2>
            </div>
          ...
          <div className="mt-4 flex justify-center ">
            <button
              type="button"
              className="flex items-center gap-2 text-sm font-medium text-neutral-500 transition hover:text-emerald-700"
            >
              <ArrowLeft size={17} />
              Volver al inicio
            </button>
