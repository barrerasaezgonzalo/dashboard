...
import { History, Leaf, LogIn, RotateCcw, Sparkles } from "lucide-react";

export default function AbandonedPlanPage() {
  return (
    <main className="relative flex min-h-screen items-center justify-center font-sans">
      ...
      <div className="relative w-full max-w-lg border border-white/50 bg-white/95 p-6 shadow-2xl backdrop-blur-md">
        ...
        <div className="flex flex-col items-center text-center mt-6">
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-orange-100 text-orange-700">
            <Leaf size={30} />
          </div>
          ...
          <p className="mt-3 max-w-md text-sm leading-6 text-neutral-500">
            A veces un plan no encaja con el momento que estamos viviendo.
            Puedes comenzar otro cuando quieras y ajustar mejor tu próxima ruta.
          </p>
        </div>
        ...
        <div className="mt-7 border-y border-neutral-200 py-5">
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              <span className="block text-2xl font-semibold text-neutral-700">
                4
              </span>
            ...
            <div>
              ...
              <span className="text-xs text-neutral-400">Difícil</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6">
          ...
          <p className="mt-2 text-sm leading-6 text-neutral-600">
            Lo que alcanzaste a registrar seguirá formando parte de tu
            historial. Esa información puede ayudarte a construir un próximo
            plan más realista y acorde a lo que necesitas ahora.
          </p>
        </div>
